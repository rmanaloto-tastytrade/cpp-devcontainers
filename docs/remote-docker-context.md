...
## Notes & Options
- Workspace location: recommended to use the remote checkout (`~/dev/github/SlotMap` cloned on the remote) to avoid slow SSHFS. The devcontainer mounts the remote path.
